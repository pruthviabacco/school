...
export default function AddFinance({ onSuccess, editData }) {
  ...
  const inputClass =
    "w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-slate-300 bg-gray-50 placeholder-gray-400 transition";
  ...
  return (
    <>
      ...
      {/* Form — 1-col on mobile, 2-col on sm+ */}
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {/* Phone spans full width on both mobile and desktop */}
        ...
        <div className="sm:col-span-2 flex justify-end mt-1">
          <button
            type="submit"
            disabled={loading}
            className="w-full sm:w-auto bg-slate-800 text-white px-6 py-2.5 rounded-lg hover:bg-slate-900 transition text-sm font-medium disabled:opacity-60"
          >
